...
import static com.whensunset.annotation_processing.inject.InjectorProcessor.CLASS_NAME;

@AutoService(Processor.class)
@SupportedAnnotationTypes({"com.whensunset.annotation.inject.Inject"})
